...
import bannerSistemaPDV from "../../assets/img/banner-sistema-pdv.webp";
import logInIcon from "../../assets/icons/login.svg";
import dotsElementImg from "../../assets/img/elements/dots.svg";
import paymentMachineImg from "../../assets/img/payment-machine.webp";
import connectionImg from "../../assets/img/no-connection.webp";
import mobileControlImg from "../../assets/img/mobile-control.webp";
import stockIcon from "../../assets/icons/stock.svg";
import faqIcon from "../../assets/icons/icon-faq.png";
import backupServerImg from "../../assets/img/server.webp";
...
import financeManagerIcon from "../../assets/icons/finance.svg";
    ...
    <div id="sistema-pdv-page">
      ...
      <main className="main-pdv-content fw">
        ...
        <div className="content-container">
          ...
          <p>
            Nosso sistema PDV te ajuda na gestão completa do seu negócio com
            facilidade e a praticidade que seu cliente merece. Você também pode
            contar com nosso suporte especializado.
          </p>
        ...
        <div className="img-container">
          ...
          <img draggable="false" src={bannerSistemaPDV} alt="Sistema PDV" loading="lazy" />
        </div>
      ...
      <SectionPDV
        title="Integração com as principais maquininhas"
        paragraph="Facilidade no atendimento para seu cliente e mais vendas para seu
        comércio. Receba seus pagamentos de forma simples."
        image={paymentMachineImg}
      />
      ...
      <section className="container text-center mt-100">
        ...
        <Slider className="mt-40" {...carouselSettings}>
          <ManagementCard
            ...
            text="Entrada de estoque por baixa de XML, entrada manual ou por 
            busca automática do sistema no SEFAZ."
          />
          <ManagementCard
            image={financeManagerIcon}
            title="Gestão Financeira"
            text="Saiba com facilidade quanto entrou, quanto foi gasto e consiga
              melhorar seu resultado. Além de crescer seu negócio com previsibilidade e escala."
          />
          <ManagementCard
            image={pdvManagerIcon}
            title="Frente de Caixa"
            text="Atenda seus clientes com agilidade e assertividade, 
              feito para proporcionar uma ótima experiência ao seu cliente.
              Rápido, simples e objetivo. Sem perca de tempo."
          />
          <ManagementCard
            image={nfceManagerIcon}
            title="Emissor Fiscal"
            text="Gerencie suas notas fiscais e esteja em conformidade
               com as normas. Seguro e aprovado: atende a todas exigências do SEFAZ."
          />
        </Slider>
      </section>

      <SectionPDV
        title="Tenha seus indicadores na palma da mão! Onde e quando quiser. Informação é dinheiro."
      ...
      <section className="some-questions container mt-100">
        ...
        >
          ...
          <div className="content-container">
            ...
            <a
              className="btn-demo some-question"
